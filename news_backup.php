                        ...
                        <div class="col-lg-4 col-md-6 mb-4" data-aos="fade-up" data-aos-delay="<?php echo ($index + 1) * 100; ?>">
                            <div class="news-card">
                                ...
                                <div class="news-content">
                                    ...
                                    <p class="news-excerpt"><?php echo htmlspecialchars(substr(strip_tags($news['content']), 0, 150)); ?><?php echo strlen(strip_tags($news['content'])) > 150 ? '...' : ''; ?></p>
                                    <a href="pages_php/news.php?id=<?php echo $news['id']; ?>" class="read-more">Read More <i class="fas fa-arrow-right"></i></a>
                                </div>
                            </div>
                        </div>
                    <?php endforeach; ?>
